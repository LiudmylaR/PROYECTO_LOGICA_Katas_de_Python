...
def factorial(n):
    ...
    Raises:
        ValueError: Se lanza si n es un número negativo, ya que el factorial no está
        definido para valores negativos
    """

    if n < 0:
        raise ValueError("Factorial no está definido para numeros negativos")
    elif n == 0 or n == 1:
        return 1
    else:
...
while True:
    ...
    try:
        ...
        numero1 = float(input("Introducir el primer número:"))
        numero2 = float(input("Introducir el segundo número:"))

        # Realizamos la división
        resultado = numero1/numero2

        # Mostramos resultado si división fue exitosa
        ...
        print("La división no fue exitosa. Error: Introducir solo valores numéricos")
...
def calcular_promedio(lista_numeros):
    ...
    Returns:
        float: Promedio de los números si la lista no está vacía.
...
def filtrar_enteros(lista_mix):
    ...
    return list(filter(lambda x: isinstance(x, int), lista_mix))
...
area_rectangulo = calcular_area("rectangulo", (10, 20))
print("El area de rectangulo es:",area_rectangulo)

area_circulo = calcular_area("circulo", (2,))
print("El area de circulo es:", area_circulo)

area_triangulo = calcular_area("triangulo", (10, 20))
print("El area de triangulo es", area_triangulo)
